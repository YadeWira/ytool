...
var
  ...
  { Estado compartido con el trabajador EraseThread (antes capturado por un
    closure; FPC 3.2.2 no tiene metodos anonimos). }
...
begin
  ...
  WriteLn(ErrOutput,
    '  ytool erase [parameters] extracted_streams original_data [decode_data]');
  WriteLn(ErrOutput, '');
  WriteLn(ErrOutput, '');
...
procedure EraseThread(X: IntPtr);
var
  Ptr: PByte;
  Y: Integer;
  C: Word;
