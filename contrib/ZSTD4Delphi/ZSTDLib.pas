...
function _ERR_getErrorString(code : ZSTD_ErrorCode):PAnsiChar; cdecl; external name 'ERR_getErrorString';
procedure _ZSTD_customFree(ptr : Pointer; customMem : ZSTD_customMem); cdecl;
  external name 'ZSTD_customFree';
function _ZSTD_customMalloc(size : NativeInt; customMem : ZSTD_customMem): Pointer;
  cdecl; external name 'ZSTD_customMalloc';
function _ZSTD_customCalloc(size : NativeInt; customMem : ZSTD_customMem): Pointer;
  cdecl; external name 'ZSTD_customCalloc';
function _ZSTD_selectBlockCompressor(strat:ZSTD_strategy; dictMode: ZSTD_dictMode_e)
  : ZSTD_blockCompressor; cdecl; external name 'ZSTD_selectBlockCompressor';
procedure _ZSTD_resetSeqStore(ssPtr : Pointer); cdecl; external name 'ZSTD_resetSeqStore';
function _ZSTD_fseBitCost(const ctable,count : Pointer; const max : Cardinal):NativeInt;
  cdecl; external name 'ZSTD_fseBitCost';
function _ZSTD_crossEntropyCost(const norm :Pointer; accuracyLog :Cardinal; const
  count : Pointer; const max : Cardinal):NativeInt; cdecl; external name 'ZSTD_crossEntropyCost';
procedure _ZSTD_seqToCodes(const seqStorePtr : Pointer); cdecl; external name 'ZSTD_seqToCodes';
function _HIST_count_wksp(count,maxSymbolValuePtr,src: Pointer; srcsize:NativeInt;
  workSpace : Pointer; workSpaceSize:NativeInt):NativeInt; cdecl; external name 'HIST_count_wksp';
function _ZSTD_noCompressLiterals(dst:Pointer; dstCapacity:NativeInt; const src :
  Pointer; srcsize : NativeInt):NativeInt; cdecl; external name 'ZSTD_noCompressLiterals';
function _ZSTD_compressRleLiteralsBlock(dst:Pointer; dstCapacity:NativeInt; const src :
  Pointer; srcsize : NativeInt):NativeInt; cdecl; external name 'ZSTD_compressRleLiteralsBlock';
function _FSE_readNCount_bmi2(normalizedCounter,maxSymbolValuePtr,tableLogPtr :
  Pointer; const rBuffer:Pointer; rBuffSize:NativeInt; bmi2:integer):NativeInt;
  cdecl; external name 'FSE_readNCount_bmi2';
function _ZSTD_getErrorCode(functionResult : NativeInt):ZSTD_ErrorCode; cdecl;
  external name 'ZSTD_getErrorCode';
function _ZSTD_loadDEntropy(entropy : Pointer; const dict : Pointer; const
  dictSize : NativeInt):NativeInt; cdecl; external name 'ZSTD_loadDEntropy';
function _HUF_readStats_wksp(huffWeight:Pointer; hwSize:NativeInt; rankStats,
  nbSymbolsPtr, tableLogPtr:Pointer; const src:Pointer; srcSize:NativeInt;
  workspace:Pointer; wkspSize:NativeInt; bmi2:integer):NativeInt; cdecl; external name 'HUF_readStats_wksp';
function _ZSTD_versionNumber:Cardinal; cdecl; external name 'ZSTD_versionNumber';
function _ZSTD_versionString:PAnsiChar; cdecl; external name 'ZSTD_versionString';
function _ZSTD_compress(dst:Pointer; dstCapacity : NativeInt; src:Pointer;
  srcSize : NativeInt; compressionLevel : integer):NativeInt; cdecl; external name 'ZSTD_compress';
function _ZSTD_decompress(dst:Pointer; dstCapacity:NativeInt; src:Pointer;
  compressedSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_decompress';
function _ZSTD_getFrameContentSize(const src:Pointer; srcsize:NativeInt):UInt64;
  cdecl; external name 'ZSTD_getFrameContentSize';
function _ZSTD_getDecompressedSize(const src:Pointer; srcSize:NativeInt):UInt64;
  cdecl; external name 'ZSTD_getDecompressedSize';
function _ZSTD_findFrameCompressedSize(const src:Pointer; srcSize:NativeInt):
  NativeInt; cdecl; external name 'ZSTD_findFrameCompressedSize';
function _ZSTD_COMPRESSBOUND(srcSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_compressBound';
function _ZSTD_isError(code : NativeInt):Cardinal; cdecl; external name 'ZSTD_isError';
function _ZSTD_getErrorName(code : NativeInt):PAnsiChar; cdecl; external name 'ZSTD_getErrorName';
function _ZSTD_minCLevel:integer; cdecl; external name 'ZSTD_minCLevel';
function _ZSTD_maxCLevel:integer; cdecl; external name 'ZSTD_maxCLevel';
function _ZSTD_createCCtx:ZSTD_CCtx; cdecl; external name 'ZSTD_createCCtx';
function _ZSTD_freeCCtx(cctx: ZSTD_CCtx):NativeInt; cdecl; external name 'ZSTD_freeCCtx';
function _ZSTD_compressCCtx(cctx:ZSTD_CCtx; dst:Pointer; dstCapacity:NativeInt;
  ...
  external name 'ZSTD_compressCCtx';
function _ZSTD_createDCtx:ZSTD_DCtx; cdecl; external name 'ZSTD_createDCtx';
function _ZSTD_freeDCtx(dctx: ZSTD_DCtx):NativeInt; cdecl; external name 'ZSTD_freeDCtx';
function _ZSTD_decompressDCtx(dctx:ZSTD_CCtx; dst:Pointer; dstCapacity:NativeInt;
  src:Pointer; srcSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_decompressDCtx';
function _ZSTD_cParam_getBounds(cParam : ZSTD_cParameter): ZSTD_bounds; cdecl; external name 'ZSTD_cParam_getBounds';
function _ZSTD_CCtx_setParameter(cctx : ZSTD_CCtx; param:ZSTD_cParameter;
  value : integer):NativeInt; cdecl; external name 'ZSTD_CCtx_setParameter';
function _ZSTD_CCtx_setPledgedSrcSize(cctx : ZSTD_CCtx; pledgedScrSize:Uint64)
  :NativeInt; cdecl; external name 'ZSTD_CCtx_setPledgedSrcSize';
function _ZSTD_CCtx_reset(cctx:ZSTD_CCtx; reset: ZSTD_ResetDirective):NativeInt;
  cdecl; external name 'ZSTD_CCtx_reset';
function _ZSTD_compress2(cctx:ZSTD_CCtx; dst:Pointer; dstCapacity:NativeInt;
  src:Pointer; srcSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_compress2';
function _ZSTD_dParam_getBounds(dParam : ZSTD_dParameter):ZSTD_bounds; cdecl; external name 'ZSTD_dParam_getBounds';
function _ZSTD_DCtx_setParameter(dctx:ZSTD_DCTx; param: ZSTD_dParameter;
  value : integer):NativeInt; cdecl; external name 'ZSTD_DCtx_setParameter';
function _ZSTD_DCtx_reset(dctx:ZSTD_DCtx; reset:ZSTD_ResetDirective):NativeInt;
  cdecl; external name 'ZSTD_DCtx_reset';
function _ZSTD_createCStream: ZSTD_CStream; cdecl; external name 'ZSTD_createCStream';
function _ZSTD_freeCStream(zsc : ZSTD_CStream):NativeInt; cdecl; external name 'ZSTD_freeCStream';
function _ZSTD_compressStream2(cctx:ZSTD_CCtx; var output:ZSTD_outBuffer;
  var input:ZSTD_inBuffer; endOp:ZSTD_EndDirective):NativeInt; cdecl; external name 'ZSTD_compressStream2';
function _ZSTD_CStreamInSize:NativeInt; cdecl; external name 'ZSTD_CStreamInSize';
function _ZSTD_CStreamOutSize:NativeInt; cdecl; external name 'ZSTD_CStreamOutSize';
function _ZSTD_initCStream(zcs:ZSTD_CStream; compressionLevel:integer):NativeInt;
  cdecl; external name 'ZSTD_initCStream';
function _ZSTD_compressStream(zcs:ZSTD_CStream; var output:ZSTD_outBuffer;
  var input:ZSTD_inBuffer):NativeInt; cdecl; external name 'ZSTD_compressStream';
function _ZSTD_flushStream(zcs:ZSTD_CStream; var output:ZSTD_outBuffer):NativeInt;
  cdecl; external name 'ZSTD_flushStream';
function _ZSTD_endStream(zcs:ZSTD_CStream; var output:ZSTD_outBuffer):NativeInt;
  cdecl; external name 'ZSTD_endStream';
function _ZSTD_createDStream: ZSTD_DStream; cdecl; external name 'ZSTD_createDStream';
function _ZSTD_freeDStream(zds : ZSTD_DStream):NativeInt; cdecl; external name 'ZSTD_freeDStream';
function _ZSTD_initDStream(zds : ZSTD_DStream):NativeInt; cdecl; external name 'ZSTD_initDStream';
function _ZSTD_decompressStream(zds:ZSTD_DStream; var output:ZSTD_outBuffer;
  var input:ZSTD_inBuffer):NativeInt; cdecl; external name 'ZSTD_decompressStream';
function _ZSTD_DStreamInSize:NativeInt; cdecl; external name 'ZSTD_DStreamInSize';
function _ZSTD_DStreamOutSize:NativeInt; cdecl; external name 'ZSTD_DStreamOutSize';
function _ZSTD_compress_usingDict(ctx:ZSTD_CCtx; dst:Pointer;
  dstCapacity:NativeInt; src:Pointer; srcSize:NativeInt; dict:Pointer;
  dictSize:NativeInt; compressionLevel:integer):NativeInt; cdecl; external name 'ZSTD_compress_usingDict';
function _ZSTD_decompress_usingDict(dctx:ZSTD_DCtx; dst:Pointer;
  dstCapacity:NativeInt; src:Pointer; srcSize:NativeInt; dict:Pointer;
  dictSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_decompress_usingDict';
function _ZSTD_createCDict(const dictBuffer:Pointer; dictSize:NativeInt;
  compressionLevel:integer):ZSTD_CDict; cdecl; external name 'ZSTD_createCDict';
function _ZSTD_freeCDict(CDict:ZSTD_CDict):NativeInt; cdecl; external name 'ZSTD_freeCDict';
function _ZSTD_compress_usingCDict(cctx:ZSTD_CCtx; dst:Pointer;
  dstCapacity:NativeInt; src:Pointer; srcSize:NativeInt; cdict:ZSTD_CDict):
  NativeInt; cdecl; external name 'ZSTD_compress_usingCDict';
function _ZSTD_createDDict(const dictBuffer:Pointer; dictSize:NativeInt):
  ZSTD_DDict; cdecl; external name 'ZSTD_createDDict';
function _ZSTD_freeDDict(CDict:ZSTD_DDict):NativeInt; cdecl; external name 'ZSTD_freeDDict';
function _ZSTD_decompress_usingDDict(dctx:ZSTD_DCtx; dst:Pointer;
  dstCapacity:NativeInt; src:Pointer; srcSize:NativeInt; ddict:ZSTD_DDict):
  NativeInt; cdecl; external name 'ZSTD_decompress_usingDDict';
function _ZSTD_getDictID_fromDict(const dict:Pointer; dictSize:NativeInt):
  Cardinal; cdecl; external name 'ZSTD_getDictID_fromDict';
function _ZSTD_getDictID_fromDDict(const dict:ZSTD_DDict; dictSize:NativeInt):
  Cardinal; cdecl; external name 'ZSTD_getDictID_fromDDict';
function _ZSTD_getDictID_fromFrame(const src:Pointer; srcSize:NativeInt):Cardinal;
  cdecl; external name 'ZSTD_getDictID_fromFrame';
function _ZSTD_CCtx_loadDictionary(cctx:ZSTD_CCtx; const dict:Pointer;
  dictSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_CCtx_loadDictionary';
function _ZSTD_CCtx_refCDict(cctx:ZSTD_CCtx; const cdict:ZSTD_CDict):NativeInt;
  cdecl; external name 'ZSTD_CCtx_refCDict';
function _ZSTD_CCtx_refPrefix(cctx:ZSTD_CCtx; const prefix:Pointer;
  prefixSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_CCtx_refPrefix';
function _ZSTD_DCtx_loadDictionary(dctx:ZSTD_DCtx; const dict:Pointer;
  dictSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_DCtx_loadDictionary';
function _ZSTD_DCtx_refDDict(dctx:ZSTD_DCtx; const ddict:ZSTD_DDict):NativeInt;
  cdecl; external name 'ZSTD_DCtx_refDDict';
function _ZSTD_DCtx_refPrefix(dctx:ZSTD_DCtx; const prefix:Pointer;
  prefixSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_DCtx_refPrefix';
function _ZSTD_sizeof_CCtx(const cctx:ZSTD_CCtx):NativeInt; cdecl; external name 'ZSTD_sizeof_CCtx';
function _ZSTD_sizeof_DCtx(const dctx:ZSTD_DCtx):NativeInt; cdecl; external name 'ZSTD_sizeof_DCtx';
function _ZSTD_sizeof_CStream(const zcs:ZSTD_CStream):NativeInt; cdecl; external name 'ZSTD_sizeof_CStream';
function _ZSTD_sizeof_DStream(const zds:ZSTD_DStream):NativeInt; cdecl; external name 'ZSTD_sizeof_DStream';
function _ZSTD_sizeof_CDict(const cdict:ZSTD_CDict):NativeInt; cdecl; external name 'ZSTD_sizeof_CDict';
function _ZSTD_sizeof_DDict(const ddict:ZSTD_DDict):NativeInt; cdecl; external name 'ZSTD_sizeof_DDict';
function _ZSTD_buildBlockEntropyStats(seqStorePtr:Pointer;const prevEntropy:
  Pointer; nextEntropy:Pointer;const cctxParams:Pointer;entropyMetadata,
  workspace:Pointer;wkspSize:NativeInt):NativeInt; cdecl; external name 'ZSTD_buildBlockEntropyStats';
